                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="password" class="form-control" id="password" name="password" name="formfield1" placeholder="Enter Password" required>
                                            </div>
                                        </div>
                                        <div class="pull-left">
                                            <a href="#" class="btn btn-primary mt-10 btn-corner" onclick="checkLogin();">Log In</a>
