...
jQuery(function ($) {
    ...
    (function ($) {
        ...
        function create_btn(that, settings) {
            ...
            var picker_btn_input = $('<input type="file" name="' + settings.name + '" accept="image/x-png, image/gif, image/jpeg" />');
        ...
        function create_preview(that, src, settings) {
            ...
            var picker_preview_remove = $('<div class="remove-profile"><button class="btn btn-danger btn-sm">Remove</button></div>');

            // The preview element
            var picker_preview = $('<div class="user-profile"></div>')
    ...
    $('#driver-table #selectAll').on('click', function (e) {
        if ($(this).is(':checked', true)) {
            $("#driver-table .check-area .checkbox").prop('checked', true);
            $('#driver-table .check-area #dropdown-table-menu').show();
        } else {
            $("#driver-table .check-area .checkbox").prop('checked', false);
            $('#driver-table .check-area #dropdown-table-menu').hide();
        }
    });
    ...
    $('#delete_all').on('click', function (e) {
        var allVals = [];
        $("#driver-table .check-area .checkbox:checked").each(function () {
    ...
    'use strict';
    var MSAFARI = window.MSAFARI || {};
    $('[data-toggle="tooltip"]').tooltip()
    /*--------------------------------
     ShowHide Image and Video :: Start
     --------------------------------*/
    $('#imguploaded').hide();
    $('#videouploaded').hide();
    $('#minimal-radio-1').on('ifChanged', function () {
        $('#imguploaded').show();
        $('#videouploaded').hide();
    });
    $('#minimal-radio-2').on('ifChanged', function () {
        $('#imguploaded').hide();
        $('#videouploaded').show();
    });
    ...
    MSAFARI.chatAPI = function () {
        ...
        $('.page-topbar .sidebar_toggle').on('click', function () {
            ...
            if (menuarea.hasClass("collapseit") || menuarea.hasClass("chat_shift")) {
                ...
                mainarea.addClass("mainsidebar-shutter");
                chatarea.addClass("hideit").removeClass("showit");
                chatwindow.addClass("hideit").removeClass("showit");
                MSAFARI.mainmenuScroll();
            } else {
                ...
                mainarea.removeClass("mainsidebar-shutter");
                MSAFARI.mainmenuCollapsed();
            }
        });
    ...
    /*--------------------------------
     CHAT API Scroll
     --------------------------------*/
    MSAFARI.chatApiScroll = function () {
    ...
    /*--------------------------------
     CHAT API window
     --------------------------------*/
    MSAFARI.chatApiWindow = function () {
    ...
    /*--------------------------------
     Viewport Checker
     --------------------------------*/
    MSAFARI.viewportElement = function () {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    MSAFARI.draggablePanels = function () {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    MSAFARI.breadcrumbAutoHidden = function () {
    ...
    /*--------------------------------
     Section Box Actions
     --------------------------------*/
    MSAFARI.sectionBoxActions = function () {
    ...
    /*--------------------------------
     Main Menu Scroll
     --------------------------------*/
    MSAFARI.mainmenuScroll = function () {
    ...
    /*--------------------------------
     Collapsed Main Menu
     --------------------------------*/
    MSAFARI.mainmenuCollapsed = function () {
    ...
    /*--------------------------------
     Extra form settings
     --------------------------------*/
    MSAFARI.extraFormSettings = function () {
    ...
    /*--------------------------------
     Pretty Photo
     --------------------------------*/
    MSAFARI.loadPrettyPhoto = function () {
    ...
    /*--------------------------------
     Gallery
     --------------------------------*/
    MSAFARI.isotopeGallery = function () {
    ...
    /*--------------------------------
     Tocify
     --------------------------------*/
    MSAFARI.tocifyScrollMenu = function () {
    ...
    /*--------------------------------
     Tooltips & Popovers
     --------------------------------*/
    MSAFARI.tooltipsPopovers = function () {
    ...
    /*--------------------------------
     Custom Dropzone
     --------------------------------*/
    MSAFARI.customDropZone = function () {
    ...
    /*--------------------------------
     Widgets
     --------------------------------*/
    MSAFARI.CRYPTONIAWidgets = function () {
    ...
    /*--------------------------------
     weather widget
     --------------------------------*/
    MSAFARI.CRYPTONIAWidgetWeather = function () {
    ...
    /*--------------------------------
     To Do Task Widget
     --------------------------------*/
    MSAFARI.CRYPTONIAToDoWidget = function () {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    MSAFARI.CRYPTONIAToDoAddTaskWidget = function () {
    ...
    /*--------------------------------
     IOS7 Switchery
     --------------------------------*/
    MSAFARI.ios7Switchery = function () {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    MSAFARI.widgetSparklineChart = function () {
...
// Element Attribute Helper
    ...
    $(document).ready(function () {
        ...
        MSAFARI.mainmenuCollapsed();
        MSAFARI.pageTopBar();
        MSAFARI.otherScripts();
        MSAFARI.iCheck();
        MSAFARI.customDropZone();
        MSAFARI.formEditors();
        MSAFARI.extraFormSettings();
        MSAFARI.tooltipsPopovers();
        MSAFARI.nestableList();
        MSAFARI.uiCalendar();
        MSAFARI.tocifyScrollMenu();
        MSAFARI.loadPrettyPhoto();
        MSAFARI.jvectorMaps();
        MSAFARI.jsTreeINIT();
        MSAFARI.breadcrumbAutoHidden();
        MSAFARI.chatAPI();
        MSAFARI.chatApiScroll();
        MSAFARI.chatApiWindow();
        MSAFARI.mailboxInbox();
        MSAFARI.CRYPTONIAWidgets();
        MSAFARI.sectionBoxActions();
        MSAFARI.draggablePanels();
        MSAFARI.viewportElement();
        MSAFARI.searchPage();
        MSAFARI.CRYPTONIAToDoAddTaskWidget();
        MSAFARI.CRYPTONIAToDoWidget();
        MSAFARI.dbjvectorMap();
        MSAFARI.widgetSparklineChart();
        MSAFARI.CRYPTONIAWidgetWeather();
        MSAFARI.onLoadTopBar();
        MSAFARI.ios7Switchery();
    });
